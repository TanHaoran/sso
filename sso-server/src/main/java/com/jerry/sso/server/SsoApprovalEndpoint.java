 ...
 * Date: 2018/5/8
 * Time: 22:00
 * Description: 这个类我们复写了WhitelabelApprovalEndpoint类对于/oauth/confirm_access的处理
 * 目的是为了可以自定义返回页面的html代码，在html代码中我们直接默认点击了同意并提交
 */
@RestController
...
public class SsoApprovalEndpoint {
    ...
    /**
     * 这里我们修改了原来的代码，隐藏了授权的那个表单，并且直接点击授权并提交
     */
